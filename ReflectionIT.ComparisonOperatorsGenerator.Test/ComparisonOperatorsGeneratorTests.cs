...
public class ComparisonOperatorsGeneratorTests {
    ...
    public async Task GenerateClass() {
        ...
        context.TestState.GeneratedSources.Add((typeof(SourceGenerator), "ComparisonOperatorsGenerator.Attributes.g.cs", ATTRIBUTE_CODE));
    ...
    public const string ATTRIBUTE_CODE_WORKAROUND = """
            using ReflectionIT.ComparisonOperatorsGenerator.Attributes;
